...
Done by **Pavithra S (106118091)** and **V Aananth (106118103)**.

## **Question**
Implement Branch prediction methods and analyze the performance

## **Answer**
The following branch prediction schemes were implemented and tested using the **[SPECint2000 gcc](https://www.cis.upenn.edu/~milom/cis501-Fall08/homework/hw3/hw3.html)** benchmark. 

Link to trace file: https://www.cis.upenn.edu/~milom/cis501-Fall08/homework/hw3/hw3.html
...
## **Sample Output for varying buffer sizes**
### **128 bits:**
![fig](./samples/128b.jpeg)
### **256 bits:**
![fig](./samples/256b.jpeg)
### **512 bits:**
![fig](./samples/512b.jpeg)
### **1k bits:**
![fig](./samples/1k.jpeg)
### **2k bits:**
![fig](./samples/2k.jpeg)
